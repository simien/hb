...
Now loaded from the KIRBY_LICENSE_KEY environment variable for security.
If not set, falls back to 'your license key' (for local/dev only).

*/

c::set('license', getenv('KIRBY_LICENSE_KEY') ?: 'your license key');
