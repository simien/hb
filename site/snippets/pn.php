...
if($page->hasNextVisible() || $page->hasPrevVisible()): ?>
    ...
    <a class="uk-background-default uk-padding" href="<?= $page->prevVisible()->url() ?>" rel="prev" title="<?= $page->prevVisible()->title()->html() ?>">
    ...
    <a class="uk-background-default uk-padding" href="<?= $page->nextVisible()->url() ?>" rel="prev" title="<?= $page->nextVisible()->title()->html() ?>">
      <div class="uk-text-uppercase rohn-b">
