...
if($page->hasNextListed() || $page->hasPrevListed()): ?>
    ...
    <a class="uk-background-default uk-padding" href="<?= $page->prevListed()->url() ?>" rel="prev" title="<?= $page->prevListed()->title()->html() ?>">
    ...
    <a class="uk-background-default uk-padding" href="<?= $page->nextListed()->url() ?>" rel="prev" title="<?= $page->nextListed()->title()->html() ?>">
      <div class="uk-text-uppercase rohn-b">
